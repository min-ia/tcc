...
EDITAVEIS_SOURCES = informacoes.tex errata.tex dedicatoria.tex \
					...
					fundamentacaoteorica.tex metodologia.tex casosdeestudo.tex sintese.tex \
					resultados.tex consideracoesFinais.tex apendices.tex anexos.tex
