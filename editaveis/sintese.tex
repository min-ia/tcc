...
\begin{quadro}
    ...
    \textbf{gera um impacto}        & não necessitar de \textit{expertise} sobre as tecnologias \\ \hline
    \textbf{devido à }              & arquitetura simplista e a simplicidade dos processos operacionais\\ \hline
    % \textbf{contudo}                & \\ \hline
    % \textbf{consciente de que este aspecto tende a} & \\ \hline
...
\begin{quadro}
    \caption{Arquitetura monolítica - síntese sobre desempenho\label{monolitico:sintese-desempenho}}
    \begin{tabularx}{\linewidth}{ | p{5cm} | X | }
    \hline
    \textbf{A escolha de uma}       & arquitetura monolítica \\ \hline
    \textbf{sob a perspectiva}      & de características arquiteturais \\ \hline
    \textbf{mediante o aspecto}     & de desempenho do sistema \\ \hline
    \textbf{gera um impacto}        & baixo desempenho \\ \hline
    \textbf{devido à }              & arquitetura simplista \\ \hline
    % \textbf{contudo}                & \\ \hline
    % \textbf{consciente de que este aspecto tende a} & \\ \hline
    \textbf{com base na}            & \autoref{pers:desempenho} \\ \hline
    \end{tabularx}
\end{quadro}
...
\begin{quadro}
    ...
    \textbf{sob a perspectiva}      & recursos necessários \\ \hline
    \textbf{mediante o aspecto}     & de recursos humanos \\ \hline
    \textbf{gera um impacto}        & necessita de \textit{expertise} sobre as tecnologias \\ \hline
...
\begin{quadro}
    \caption{Arquitetura de microsserviços - síntese sobre desempenho\label{microsservicos:sintese-desempenho}}
    \begin{tabularx}{\linewidth}{ | p{5cm} | X | }
    \hline
    \textbf{A escolha de uma}       & arquitetura de microsserviços \\ \hline
    \textbf{sob a perspectiva}      & de características arquiteturais \\ \hline
