...
% \begin{description}
%     \item [Perspectiva:] ponto de vista sob o qual a arquitetura está sendo analisada;
%     \item [Aspecto:] quais aspectos impactam a arquitetura dentro daquela perspectiva;
%     \item [Impacto:] qual o impacto que um dado aspecto causa em relação a arquitetura;
%     \item [Causa:] qual fator presente na natureza daquela arquitetura é responsável por gerar o dado impacto;
%     \item [Fatores adversos:] fatores que podem ser trabalhados com o intuito de minimizar o impacto;
%     \item [Constância] tendência do impacto a aumentar ou diminuir a medida que a base de código
%         cresce.
% \end{description}
...
\begin{figure}[h]
  \centering
  \includegraphics[keepaspectratio=true,scale=0.8]{figuras/sintese-monolitico-1.eps}
  \caption{Síntese do monolítico\label{fig:ArquiteturaFase1}}
\end{figure}
...
\subsubsection{Perspectivas sobre o caso de estudo}

% Eu não vou avaliar a escolha ou não de uma arquitetura X.
% Eu vou avaliar se o caso de estudo evidência ou não uma perpectiva/aspecto X

% 1. Problemática da aplicação
%     1. Domínio do contexto
%     1. Tamanho da aplicação
% 1. Recursos
%     1. Recursos financeiros
%     1. Recursos humanos
%     1. Esforço e tempo inicial
...
% 1. Evolucionabilidade
%     1. Heterogeneidade das tecnologias
%     1. Complexidade
