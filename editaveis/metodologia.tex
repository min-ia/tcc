...
Estas fases serão abordadas na seção \ref{sec:ArquiteturaDoSistema} e serão
...
Para cada um dos itens definidos sera executado o processo ilustrado na Figura
\ref{fig:ProcessoAnaliseComparativa} com o propósito de definir os métodos utilizados
e coletar os dados.

    \begin{figure}[h]
      \centering
      \includegraphics[keepaspectratio=true,scale=0.5]{figuras/metodologiaAnalise.eps}
      \caption{Processo para realização da coleta de dados}
      \label{fig:ProcessoAnaliseComparativa}
    \end{figure}
